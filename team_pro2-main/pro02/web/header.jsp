    ...
    <nav class="gnb">
        <ul class="menu">
            ...
            <li class="item2">
                ...
                <ul class="sub">
                    <li><a class="move" href="${path2}/ProList.do?cate=D">교과서</a></li>
                    <li><a class="move" href="${path2}/ProList.do?cate=E">참고서</a></li>
                    <li><a class="move" href="${path2}/ProList.do?cate=F">문제집</a></li>
                </ul>
            </li>
            <li class="item3">
                <a href="${path2}/ProList.do?cate=고등" class="dp1">고등 도서</a>
                <ul class="sub">
                    <li><a class="move" href="${path2}/ProList.do?cate=G">교과서</a></li>
                    <li><a class="move" href="${path2}/ProList.do?cate=H">참고서</a></li>
                    <li><a class="move" href="${path2}/ProList.do?cate=I">문제집</a></li>
                </ul>
            </li>
            <li class="item1">
                <a href="${path2}/ProList.do?cate=기타" class="dp1">기타</a>
                <ul class="sub">
                    <li><a class="move" href="${path2}/ProList.do?cate=J">일반</a></li>
                </ul>
            </li>
