...
<%@ page import="shop.dto.Notice" %>
<%@ page import="shop.model.DBConnect" %>
...
<head>
    ...
    <style>
        /* 본문 영역 스타일 */
        .contents { clear:both; min-height: 180vh; background-color: #fff;
        ...
        <section class="page" id="page1">
            <div class="page_wrap">
                ...
                <table class="tb1">
                    <thead>
                        <tr class="title">
                            <th colspan="5">${noti.title}</th>
                        </tr>
                        <tr>
                            <td>
                                <c:if test="${sid eq 'admin' }">
                                    <a href="${path}/UpdateNotice.do?no=${noti.no}" class="inbtn">수정</a>
                                </c:if>
                            </td>
                            <td>
                                <c:if test="${sid eq 'admin' }">
                                    <a href="${path}/DeleteNotice.do?no=${noti.no}" class="inbtn delete_btn">삭제</a>
                                </c:if>
                            </td>
                            <td>관리자</td>
                            <td>${noti.resdate}</td>
                            <td>조회수 ${noti.visited}</td>
                        </tr>
                    </thead>
                    <tbody>
                    <tr>
