...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="/admin/baordList.jsp">재고관리</a></p>
        </div>
        <section class="page" id="page1">
            <div class="page_wrap">
                <h2 class="page_tit">재고 관리</h2>
                ...
                <table class="tb1" id="myTable">
                    ...
                    <tr>
                        ...
                        <th class="item3" style="text-align: center">카테고리명</th>
                        <th class="item4" style="text-align: center">총재고수량</th>
                        <th class="item5" style="text-align: center">총판매량</th>
                        <th class="item6" style="text-align: center">총판매가격</th>
                        <th class="item7" style="text-align: center">상세보기</th>
                    ...
                    <c:forEach var="inv" items="${invList }" varStatus="status">
                        ...
                        <c:if test="${cus.id ne 'admin'}">
                            <tr>
                                ...
                                <td class="item3">${inv.cname}</td>
                                <td class="item4">${inv.totalamount}</td>
                                <td class="item5">${inv.saleamount}</td>
                                <td class="item6">${inv.saleprice}</td>
                                <td class="item7">
                                    <a href="${path}/InventoryPro.do?cate=${inv.cate}"class="inbtn delete_btn">상세보기</a>
                                </td>
                ...
                <a href="${path}/AddReceive.do?pno=${inv.pno}"class="inbtn delete_btn">입고</a>
